...
　RESETボタンを押しても動作がおかしくならないようにするには、SD対応としたMONITOR(SB-1520、MZ-1Z001M)の0000h～129Fhを0000h～129Fhに配置、12B6h～190ChをF800h～FE56hに配置、S-OS SWORDを1300h～に配置したうえで00AEhからの3ByteをC3 FD 1Fと修正して0000h～FE56hを実行アドレス0000hのMZTファイルとして保存します。
