...
これで0000h～93BAhまでのバイナリファイルとなります。
...
　[0010] 0D 0D BB 93 00 00 00 90 00 00 00 00 00 00 00 00
...
#### 注)
 オーナーズマニュアルでは「MONITOR MZ-1Z001M、または、2Z-004Aによって作成したOBJモードのファイルに対しLOADコマンドを実行すると、Z80側へローディングされます」となっていますが、このパッチではZ80側へ書き込まない設定にしてあります。
